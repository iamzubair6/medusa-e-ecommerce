...
export function EmailPreview({ subject, heading, body }: { subject: string; heading: string; body: string }) {
  const html = emailShell(fillPlaceholders(heading || " ", SAMPLE_VARS), fillPlaceholders(body || "", SAMPLE_VARS));
  return (
